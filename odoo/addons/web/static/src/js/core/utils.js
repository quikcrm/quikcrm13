...
var utils = {
    ...
    human_number: function (number, decimals, minDigits, formatterCallback) {
        ...
        //     }
        // }
        var result = utils.convertNumberToWords(number)
        return formatterCallback('' + result.no) + result.sym;
        // kinjal commented
...
//    console.log('----n_length',n_length)
    if (n_length <= 9) {
        ...
        var value = "";
//        console.log('n_aaray----------',n_array )
        var cr = false
        var lkh = false
        var th = false
        var amt=0;
        for (var i = 0; i < 9; i++) {
//            console.log('n_array[i]s---------',n_array[i])
            if (i == 0 || i == 2 || i == 4 || i == 7) {
                value = n_array[i] * 10;
            } else {
                value = n_array[i];
...
//                }
            if ((i == 1 && value != 0) || (i == 0 && value != 0)) {
                if (cr == false) {
                words_string += "Cr ";
                
                }
                amt +=parseInt(value);
//                console.log('amt in cr---------',amt)
                cr=true
            }
            if ((i == 3 && value != 0) || (i == 2 && value != 0)) {
                if (cr==false){
                    if(lkh == false) {
                        words_string += "L";
                        }
                amt +=parseInt(value);
//                console.log('amt in ll---------',amt)
                lkh=true
                }

            }
            if ((i === 5 && value !== 0) || (i === 4 && value !== 0)) {
//                console.log('cr---------',lkh,cr)
                if (lkh===false && cr===false){
                    if(th === false) {
                        words_string += "K";
                        }
                amt +=parseInt(value);
//                console.log('amt in thh---------',amt)
                th=true
                }
...
//                    amt +=value;
//                    }
            if ((i == 6 && value != 0) || (i == 7 && value != 0)|| (i == 8 && value != 0))  {
//                console.log('--------final loop',amt)
                if (th==false && lkh===false && cr===false ){
                amt +=parseInt(amount);
                break
                }
            }
        }
//        console.log('-----after cr',)
//        console.log("AMT----------",amt)
        no =amt;
        sym =words_string;
    }
