...
class HrEmployee(models.Model):
    ...
    appraisal_date_related = fields.Date(related="appraisal_date", groups="hr.group_hr_user", string="Appraisal Date", help="Used to configure the appraisal date", readonly=False)
    ...
    def _new_employee_appraisal_date(self):  #fixes appraisal date issues in 12.3 and 13.0, 13.1, drop in master
        ...
        for employee in self.search([('appraisal_date', '=', False)]):
            ...
            employee.write({
                'appraisal_date': date + relativedelta(months=months),
                'periodic_appraisal_created': False
            })
